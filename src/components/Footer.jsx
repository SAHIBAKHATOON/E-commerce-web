  ...
  return (
     ...
     <div className='footer-section'>
      ...
      <div className="shopping">
        ...
        <ul>
          <p> <i class="ri-map-pin-2-line"></i>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam reprehenderit voluptate corrupti enim dicta alias.</p>
          <li> <i class="ri-phone-line"></i>Contact Us: 748392938424</li>
          <li>Email Us: abc@gmail.com</li>
